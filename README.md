...
$$
\hat b = rac{35533.2000}{7483.6000} = 4.7481
$$
...
$$
A = rac{100%}{n}\sum_{i=1}^n \left|rac{y_i - \hat y_i}{y_i}
ight|
$$
Для линейной модели:
...
$$
s^2 = rac{69634.0325}{60 - 2} = 1200.5868
$$
...
$$
SE(\hat b) = rac{s}{\sqrt{S_{xx}}}
$$

$$
SE(\hat b) = rac{34.6495}{\sqrt{7483.6000}} = 0.4005
$$

Стандартная ошибка свободного коэффициента:

$$
SE(\hat a) = s\sqrt{rac{1}{n} + rac{\overline{x}^2}{S_{xx}}}
$$
...
Доверительный интервал для $b$ не содержит ноль. Это означает, что коэффициент при $x$ статистически значим на уровне значимости $lpha = 0.05$.
...
$$
t_{набл} = rac{\hat b}{SE(\hat b)}
$$

$$
t_{набл} = rac{4.7481}{0.4005} = 11.8545
$$
