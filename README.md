...
это показатель, который показывает общий размер ошибок модели.
...
показатель того, насколько сильно в целом разбросаны ошибки модели.
...
оценка погрешности, с которой мы нашли коэффициент по выборке.
